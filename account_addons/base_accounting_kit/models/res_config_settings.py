...
class ResConfigSettings(models.TransientModel):
    ...
    fiscalyear_last_month = fields.Selection(
        ...
        compute='_compute_fiscalyear_last_month',
        inverse='_inverse_fiscalyear_last_month',
    )

    def _compute_fiscalyear_last_month(self):
        for config in self:
            config.fiscalyear_last_month = config.company_id.fiscalyear_last_month

    def _inverse_fiscalyear_last_month(self):
        for config in self:
            config.company_id.fiscalyear_last_month = config.fiscalyear_last_month
