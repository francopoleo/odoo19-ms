# Guia de Implementação — Governance Property
...
Implementar o módulo `governance_property` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.

## 2. Dependências

governance, property_core
...
./odoo-bin -d ms-teste -u governance_property,common_help_center --stop-after-init
```
