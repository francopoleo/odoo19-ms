# Ajuda Contextual — Governance Property
...
<!-- HELP:ARTICLE
code: governance_property.governance_case.list.overview
module: governance_property
model: governance.case
view_type: list
category: Integração Governança + Imóveis
...
<!-- HELP:ARTICLE
code: governance_property.governance_case.form.fill
module: governance_property
model: governance.case
view_type: form
category: Integração Governança + Imóveis
