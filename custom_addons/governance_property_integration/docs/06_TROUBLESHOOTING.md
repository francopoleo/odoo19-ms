# Troubleshooting — Governance Property
...
```sql
DELETE FROM help_article WHERE module_name = 'governance_property';
DELETE FROM help_context WHERE module_name = 'governance_property';
```
