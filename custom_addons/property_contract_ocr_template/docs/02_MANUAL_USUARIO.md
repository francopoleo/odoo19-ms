# Manual do Usuário — Property Contract OCR Templates
...
### Fluxo 1: Criar template OCR

**Objetivo:** Definir padrões de detecção, regex de campos e prioridade.


#### Quando usar

Use este fluxo quando o usuário precisar executar **criar template ocr** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 2: Testar template

**Objetivo:** Executar contra contratos de exemplo e validar campos extraídos.


#### Quando usar

Use este fluxo quando o usuário precisar executar **testar template** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 3: Ajustar regex

**Objetivo:** Melhorar captura sem quebrar modelos já homologados.


#### Quando usar

Use este fluxo quando o usuário precisar executar **ajustar regex** de forma rastreável, com responsável definido e histórico preservado.
