# Manual do Usuário — Document S3 Storage
...
### Fluxo 1: Configurar storage

**Objetivo:** Informar endpoint, bucket, credenciais e política de upload.


#### Quando usar

Use este fluxo quando o usuário precisar executar **configurar storage** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 2: Testar upload

**Objetivo:** Enviar documento e validar URL/chave no storage.


#### Quando usar

Use este fluxo quando o usuário precisar executar **testar upload** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 3: Auditar falha

**Objetivo:** Verificar permissões, tamanho e credenciais.


#### Quando usar

Use este fluxo quando o usuário precisar executar **auditar falha** de forma rastreável, com responsável definido e histórico preservado.
