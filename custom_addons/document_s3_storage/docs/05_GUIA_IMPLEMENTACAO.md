# Guia de Implementação — Document S3 Storage
...
Implementar o módulo `document_s3_storage` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.

## 2. Dependências

document_core, base, base_setup
...
./odoo-bin -d ms-teste -u document_s3_storage,common_help_center --stop-after-init
```
