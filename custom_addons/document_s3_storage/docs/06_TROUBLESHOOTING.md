# Troubleshooting — Document S3 Storage
...
```sql
DELETE FROM help_article WHERE module_name = 'document_s3_storage';
DELETE FROM help_context WHERE module_name = 'document_s3_storage';
```
