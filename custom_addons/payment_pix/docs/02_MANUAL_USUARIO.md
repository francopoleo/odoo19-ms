# Manual do Usuário — Payment Provider: PIX (BACEN)
...
### Fluxo 1: Configurar PIX

**Objetivo:** Definir provedor, chave, credenciais e ambiente.


#### Quando usar

Use este fluxo quando o usuário precisar executar **configurar pix** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 2: Gerar cobrança

**Objetivo:** Criar cobrança PIX para pagamento.


#### Quando usar

Use este fluxo quando o usuário precisar executar **gerar cobrança** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 3: Conciliar retorno

**Objetivo:** Validar pagamento recebido e vínculo financeiro.


#### Quando usar

Use este fluxo quando o usuário precisar executar **conciliar retorno** de forma rastreável, com responsável definido e histórico preservado.
