# Manual do Usuário — Property Document Portal
...
- Locatário/proprietário externo
- Operador documental
...
### Fluxo 1: Publicar documento no portal

**Objetivo:** Selecionar documento, definir visibilidade e público autorizado.


#### Quando usar

Use este fluxo quando o usuário precisar executar **publicar documento no portal** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 2: Revisar acesso externo

**Objetivo:** Confirmar que apenas partes corretas visualizam o documento.


#### Quando usar

Use este fluxo quando o usuário precisar executar **revisar acesso externo** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 3: Retirar publicação

**Objetivo:** Arquivar ou despublicar sem apagar histórico.


#### Quando usar

Use este fluxo quando o usuário precisar executar **retirar publicação** de forma rastreável, com responsável definido e histórico preservado.
