# Guia de Implementação — Property Document Portal
...
Implementar o módulo `property_document_portal` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.

## 2. Dependências

property_core, document_core, portal
...
./odoo-bin -d ms-teste -u property_document_portal,common_help_center --stop-after-init
```
