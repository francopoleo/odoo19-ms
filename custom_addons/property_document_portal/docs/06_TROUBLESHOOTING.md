# Troubleshooting — Property Document Portal
...
```sql
DELETE FROM help_article WHERE module_name = 'property_document_portal';
DELETE FROM help_context WHERE module_name = 'property_document_portal';
```
