# Manual do Usuário — Histórico de Contratos com OCR
...
### Fluxo 1: Importar contrato histórico

**Objetivo:** Subir arquivo original, preservar nome e executar OCR/texto.


#### Quando usar

Use este fluxo quando o usuário precisar executar **importar contrato histórico** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 2: Revisar extração

**Objetivo:** Validar locador, locatário, datas, valores, imóvel e cláusulas.


#### Quando usar

Use este fluxo quando o usuário precisar executar **revisar extração** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 3: Criar contrato

**Objetivo:** Criar contrato somente quando campos obrigatórios estiverem consistentes.


#### Quando usar

Use este fluxo quando o usuário precisar executar **criar contrato** de forma rastreável, com responsável definido e histórico preservado.
