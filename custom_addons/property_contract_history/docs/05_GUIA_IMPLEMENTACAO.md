# Guia de Implementação — Histórico de Contratos com OCR
...
Implementar o módulo `property_contract_history` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.

## 2. Dependências

property_core, property_payment_proof, mail
...
./odoo-bin -d ms-teste -u property_contract_history,common_help_center --stop-after-init
```
