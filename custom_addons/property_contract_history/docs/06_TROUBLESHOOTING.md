# Troubleshooting — Histórico de Contratos com OCR
...
```sql
DELETE FROM help_article WHERE module_name = 'property_contract_history';
DELETE FROM help_context WHERE module_name = 'property_contract_history';
```
