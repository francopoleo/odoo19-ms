# Ajuda Contextual — Histórico de Contratos com OCR
...
<!-- HELP:ARTICLE
code: property_contract_history.property_contract_history.list.overview
module: property_contract_history
model: property.contract.history
view_type: list
category: Histórico Contratual e OCR
context_name: Lista de History
title: Como usar a lista de History
article_type: howto
scope: context
audience: user
sequence: 10
...
<!-- HELP:ARTICLE
code: property_contract_history.property_contract_history.form.fill
module: property_contract_history
model: property.contract.history
view_type: form
category: Histórico Contratual e OCR
context_name: Formulário de History
title: Como preencher History
article_type: flow
scope: flow
audience: user
sequence: 11
