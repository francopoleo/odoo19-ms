...
- Gestor operacional
- Técnico responsável por integrações
...
### Fluxo 1: Configurar Agenda Geral

**Objetivo:** Definir responsáveis, visibilidade, categorias operacionais e validar se os compromissos aparecem apenas para quem deve ver.


#### Quando usar

Use este fluxo quando o usuário precisar executar **configurar agenda geral** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 2: Sincronizar Atividade e Agenda

**Objetivo:** Criar uma atividade para cobrança interna e um evento operacional em Agenda Geral apenas quando for marco relevante.


#### Quando usar

Use este fluxo quando o usuário precisar executar **sincronizar atividade e agenda** de forma rastreável, com responsável definido e histórico preservado.
