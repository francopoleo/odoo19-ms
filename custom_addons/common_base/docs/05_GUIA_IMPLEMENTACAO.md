# Guia de Implementação — Common Base
...
Implementar o módulo `common_base` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.
...
./odoo-bin -d ms-teste -u common_base,common_help_center --stop-after-init
```
