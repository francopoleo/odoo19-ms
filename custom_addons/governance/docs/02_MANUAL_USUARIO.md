# Manual do Usuário — Governance & Audit
...
- Gestor jurídico/administrativo
...
### Fluxo 1: Abrir caso de governança

**Objetivo:** Registrar assunto, tipo, prioridade, responsável, prazos de resposta/resolução e canal de origem.


#### Quando usar

Use este fluxo quando o usuário precisar executar **abrir caso de governança** de forma rastreável, com responsável definido e histórico preservado.
...
**Resultado esperado:** a Agenda Geral recebe apenas os marcos críticos: `Prazo de Resposta - Reclamação de infiltração` e `Prazo de Resolução - Reclamação de infiltração`. Atividades simples continuam no chatter do caso.
...
### Fluxo 2: Criar pendência formal

**Objetivo:** Registrar obrigação com responsável e vencimento; pendência formal pode gerar marco na Agenda Geral.


#### Quando usar

Use este fluxo quando o usuário precisar executar **criar pendência formal** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 3: Tratar comunicação

**Objetivo:** Registrar troca institucional por e-mail, reunião ou contato, mantendo histórico do caso.


#### Quando usar

Use este fluxo quando o usuário precisar executar **tratar comunicação** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 4: Encerrar caso

**Objetivo:** Concluir marcos abertos e preservar histórico.


#### Quando usar

Use este fluxo quando o usuário precisar executar **encerrar caso** de forma rastreável, com responsável definido e histórico preservado.
