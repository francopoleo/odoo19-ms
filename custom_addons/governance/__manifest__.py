{
    ...
    "data": [
        ...
        "views/governance_enterprise_views.xml",
        "views/governance_agenda_views.xml",
        "views/governance_dashboard_views.xml",
        "views/governance_enterprise_dashboard_views.xml",
