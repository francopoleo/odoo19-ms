# Guia de Implementação — Property Core
...
Implementar o módulo `property_core` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.

## 2. Dependências

mail, common_base, governance, portal, website, account, document_core
...
./odoo-bin -d ms-teste -u property_core,common_help_center --stop-after-init
```
