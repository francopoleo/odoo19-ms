# Troubleshooting — Document Dossier - Aggregator
...
```sql
DELETE FROM help_article WHERE module_name = 'document_dossier';
DELETE FROM help_context WHERE module_name = 'document_dossier';
```
