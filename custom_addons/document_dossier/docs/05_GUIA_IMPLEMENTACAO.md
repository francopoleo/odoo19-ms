# Guia de Implementação — Document Dossier - Aggregator
...
Implementar o módulo `document_dossier` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.
...
./odoo-bin -d ms-teste -u document_dossier,common_help_center --stop-after-init
```
