# Manual do Usuário — Document Dossier - Aggregator
...
### Fluxo 1: Criar dossiê

**Objetivo:** Criar dossiê por finalidade, associar documentos obrigatórios e acompanhar completude.


#### Quando usar

Use este fluxo quando o usuário precisar executar **criar dossiê** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 2: Aplicar template

**Objetivo:** Usar template para exigir tipos documentais e validar pendências.


#### Quando usar

Use este fluxo quando o usuário precisar executar **aplicar template** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 3: Converter documentos avulsos

**Objetivo:** Associar documentos existentes a um dossiê sem perder histórico.


#### Quando usar

Use este fluxo quando o usuário precisar executar **converter documentos avulsos** de forma rastreável, com responsável definido e histórico preservado.
