# Troubleshooting — Document Dossier - Property Integration
...
```sql
DELETE FROM help_article WHERE module_name = 'document_dossier_property';
DELETE FROM help_context WHERE module_name = 'document_dossier_property';
```
