# Guia de Implementação — Document Dossier - Property Integration
...
Implementar o módulo `document_dossier_property` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.

## 2. Dependências

document_dossier, property_core
...
./odoo-bin -d ms-teste -u document_dossier_property,common_help_center --stop-after-init
```
