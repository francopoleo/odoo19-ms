# Manual do Usuário — Document Dossier - Property Integration
...
### Fluxo 1: Criar vínculo integrado

**Objetivo:** Associar registros dos módulos envolvidos preservando origem e histórico.


#### Quando usar

Use este fluxo quando o usuário precisar executar **criar vínculo integrado** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 2: Acompanhar processo integrado

**Objetivo:** Validar documentos, pendências e responsáveis sem duplicar informação.


#### Quando usar

Use este fluxo quando o usuário precisar executar **acompanhar processo integrado** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 3: Auditar integração

**Objetivo:** Verificar se menus, botões e permissões respeitam os dois módulos.


#### Quando usar

Use este fluxo quando o usuário precisar executar **auditar integração** de forma rastreável, com responsável definido e histórico preservado.
