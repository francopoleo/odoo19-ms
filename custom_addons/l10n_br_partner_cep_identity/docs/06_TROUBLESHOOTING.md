# Troubleshooting — Brasil - Contatos: CEP e Documentos
...
```sql
DELETE FROM help_article WHERE module_name = 'l10n_br_partner_cep_identity';
DELETE FROM help_context WHERE module_name = 'l10n_br_partner_cep_identity';
```
