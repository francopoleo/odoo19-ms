# Ajuda Contextual — Brasil - Contatos: CEP e Documentos
...
<!-- HELP:ARTICLE
code: l10n_br_partner_cep_identity.res_partner.list.overview
module: l10n_br_partner_cep_identity
model: res.partner
view_type: list
category: Contatos Brasil
context_name: Lista de Partner
title: Como usar a lista de Partner
article_type: howto
scope: context
audience: user
sequence: 10
...
<!-- HELP:ARTICLE
code: l10n_br_partner_cep_identity.res_partner.form.fill
module: l10n_br_partner_cep_identity
model: res.partner
view_type: form
category: Contatos Brasil
context_name: Formulário de Partner
title: Como preencher Partner
article_type: flow
scope: flow
audience: user
sequence: 11
