# Guia de Implementação — Brasil - Contatos: CEP e Documentos
...
Implementar o módulo `l10n_br_partner_cep_identity` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.
...
./odoo-bin -d ms-teste -u l10n_br_partner_cep_identity,common_help_center --stop-after-init
```
