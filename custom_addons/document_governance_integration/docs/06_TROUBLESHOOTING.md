# Troubleshooting — Governance Documents
...
```sql
DELETE FROM help_article WHERE module_name = 'governance_documents';
DELETE FROM help_context WHERE module_name = 'governance_documents';
```
