# Guia de Implementação — Governance Documents
...
Implementar o módulo `governance_documents` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.

## 2. Dependências

governance, document_core
...
./odoo-bin -d ms-teste -u governance_documents,common_help_center --stop-after-init
```
