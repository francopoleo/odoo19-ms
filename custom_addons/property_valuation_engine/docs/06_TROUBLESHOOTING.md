# Troubleshooting — Property Valuation Engine
...
```sql
DELETE FROM help_article WHERE module_name = 'property_valuation_engine';
DELETE FROM help_context WHERE module_name = 'property_valuation_engine';
```
