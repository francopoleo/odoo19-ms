# Manual do Usuário — Property Valuation Engine
...
### Fluxo 1: Criar estimativa

**Objetivo:** Selecionar imóvel, critérios e referência de mercado.


#### Quando usar

Use este fluxo quando o usuário precisar executar **criar estimativa** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 2: Revisar fatores

**Objetivo:** Ajustar padrão construtivo, localização, metragem e comparáveis.


#### Quando usar

Use este fluxo quando o usuário precisar executar **revisar fatores** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 3: Homologar valor

**Objetivo:** Registrar valor final e observações.


#### Quando usar

Use este fluxo quando o usuário precisar executar **homologar valor** de forma rastreável, com responsável definido e histórico preservado.
