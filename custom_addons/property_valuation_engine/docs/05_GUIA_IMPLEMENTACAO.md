# Guia de Implementação — Property Valuation Engine
...
Implementar o módulo `property_valuation_engine` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.
...
./odoo-bin -d ms-teste -u property_valuation_engine,common_help_center --stop-after-init
```
