# Guia de Implementação — Conciliação Inteligente de Comprovantes de Aluguel
...
Implementar o módulo `property_payment_proof` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.

## 2. Dependências

property_core, account, mail
...
./odoo-bin -d ms-teste -u property_payment_proof,common_help_center --stop-after-init
```
