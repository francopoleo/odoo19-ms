# Ajuda Contextual — Conciliação Inteligente de Comprovantes de Aluguel
...
<!-- HELP:ARTICLE
code: property_payment_proof.property_payment_proof.list.overview
module: property_payment_proof
model: property.payment.proof
view_type: list
category: Comprovantes e Conciliação
context_name: Lista de Proof
title: Como usar a lista de Proof
article_type: howto
scope: context
audience: user
sequence: 10
...
<!-- HELP:ARTICLE
code: property_payment_proof.property_payment_proof.form.fill
module: property_payment_proof
model: property.payment.proof
view_type: form
category: Comprovantes e Conciliação
context_name: Formulário de Proof
title: Como preencher Proof
article_type: flow
scope: flow
audience: user
sequence: 11
