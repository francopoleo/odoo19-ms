# Manual do Usuário — Conciliação Inteligente de Comprovantes de Aluguel
...
### Fluxo 1: Registrar comprovante

**Objetivo:** Importar PDF/imagem do comprovante, preservar arquivo original e extrair dados por OCR.


#### Quando usar

Use este fluxo quando o usuário precisar executar **registrar comprovante** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 2: Conciliar parcela

**Objetivo:** Relacionar valor, pagador, data e imóvel/contrato à parcela correta.


#### Quando usar

Use este fluxo quando o usuário precisar executar **conciliar parcela** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 3: Tratar divergência

**Objetivo:** Marcar diferença de valor, atraso ou pagador alternativo para revisão.


#### Quando usar

Use este fluxo quando o usuário precisar executar **tratar divergência** de forma rastreável, com responsável definido e histórico preservado.
