# Troubleshooting — Conciliação Inteligente de Comprovantes de Aluguel
...
```sql
DELETE FROM help_article WHERE module_name = 'property_payment_proof';
DELETE FROM help_context WHERE module_name = 'property_payment_proof';
```
