# Guia de Implementação — Document Core
...
Implementar o módulo `document_core` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.
...
./odoo-bin -d ms-teste -u document_core,common_help_center --stop-after-init
```
