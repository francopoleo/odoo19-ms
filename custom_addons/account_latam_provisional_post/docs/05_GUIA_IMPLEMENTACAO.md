# Guia de Implementação — Documento Fiscal Provisório LATAM/Brasil
...
Implementar o módulo `account_latam_provisional_post` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.
