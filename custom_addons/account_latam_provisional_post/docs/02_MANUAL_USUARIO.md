# Manual do Usuário — Documento Fiscal Provisório LATAM/Brasil
...
### Fluxo 1: Confirmar com número provisório

**Objetivo:** Postar documento quando o número fiscal real ainda não existe.


#### Quando usar

Use este fluxo quando o usuário precisar executar **confirmar com número provisório** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 2: Substituir número real

**Objetivo:** Atualizar número fiscal definitivo no momento correto.


#### Quando usar

Use este fluxo quando o usuário precisar executar **substituir número real** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 3: Auditar provisórios

**Objetivo:** Listar documentos ainda pendentes de número real.


#### Quando usar

Use este fluxo quando o usuário precisar executar **auditar provisórios** de forma rastreável, com responsável definido e histórico preservado.
