# Ajuda Contextual — Contratos e Aditivos Imobiliários Empresarial
...
<!-- HELP:ARTICLE
code: property_contract_amendment_enterprise.property_contract_amendment.list.overview
module: property_contract_amendment_enterprise
model: property.contract.amendment
view_type: list
category: Contratos e Aditivos
context_name: Lista de Amendment
title: Como usar a lista de Amendment
article_type: howto
scope: context
audience: user
sequence: 10
...
-->
# Como usar a lista de Amendment
...
<!-- HELP:ARTICLE
code: property_contract_amendment_enterprise.property_contract_amendment.form.fill
module: property_contract_amendment_enterprise
model: property.contract.amendment
view_type: form
category: Contratos e Aditivos
context_name: Formulário de Amendment
title: Como preencher Amendment
article_type: flow
scope: flow
audience: user
sequence: 11
