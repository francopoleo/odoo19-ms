...
### Fluxo 1: Criar aditivo

**Objetivo:** Selecionar contrato, tipo de alteração e data de vigência.


#### Quando usar

Use este fluxo quando o usuário precisar executar **criar aditivo** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 2: Alterar valor

**Objetivo:** Registrar alteração de aluguel e propagar para parcelas futuras conforme regra.


#### Quando usar

Use este fluxo quando o usuário precisar executar **alterar valor** de forma rastreável, com responsável definido e histórico preservado.
...
### Fluxo 3: Auditar impacto

**Objetivo:** Revisar parcelas afetadas, documentos gerados e histórico.


#### Quando usar

Use este fluxo quando o usuário precisar executar **auditar impacto** de forma rastreável, com responsável definido e histórico preservado.
