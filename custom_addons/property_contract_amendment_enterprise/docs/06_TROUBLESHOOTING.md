# Troubleshooting — Contratos e Aditivos Imobiliários Empresarial
...
```sql
DELETE FROM help_article WHERE module_name = 'property_contract_amendment_enterprise';
DELETE FROM help_context WHERE module_name = 'property_contract_amendment_enterprise';
```
