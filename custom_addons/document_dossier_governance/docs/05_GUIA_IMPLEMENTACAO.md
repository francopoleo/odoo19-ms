# Guia de Implementação — Document Dossier - Governance Integration
...
Implementar o módulo `document_dossier_governance` na base Odoo garantindo configuração funcional, segurança, documentação e testes de aceite.

## 2. Dependências

document_dossier, governance
...
./odoo-bin -d ms-teste -u document_dossier_governance,common_help_center --stop-after-init
```
