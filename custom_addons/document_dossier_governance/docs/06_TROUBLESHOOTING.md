# Troubleshooting — Document Dossier - Governance Integration
...
```sql
DELETE FROM help_article WHERE module_name = 'document_dossier_governance';
DELETE FROM help_context WHERE module_name = 'document_dossier_governance';
```
