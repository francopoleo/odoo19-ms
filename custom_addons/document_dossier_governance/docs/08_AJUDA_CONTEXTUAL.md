# Ajuda Contextual — Document Dossier - Governance Integration
...
<!-- HELP:ARTICLE
code: document_dossier_governance.governance_case.list.overview
module: document_dossier_governance
model: governance.case
view_type: list
category: Integração Dossiê + Governança
...
<!-- HELP:ARTICLE
code: document_dossier_governance.governance_case.form.fill
module: document_dossier_governance
model: governance.case
view_type: form
category: Integração Dossiê + Governança
